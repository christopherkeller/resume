...
\begin{itemize}
    ...
    \item\
        ...
        \headerrow {\emph{Principal Architect, Office of the CTO Emerging Business Group}} {\emph{Since 2015}}
        \begin{itemize*}
            \item\ Work directly with CTO for Emerging Business Group  
            \item\ Responsible for integration of all new and emerging technologies into CSC reference architectures such as OpenStack, Docker, Cassandra, Dispersive Networks          
            ...
            \begin{itemize*}
              \item\ Build out of Center of Excellence for Emerging Technologies data center in Austin, Texas
              \item\ PCI, FISMA, HIPAA compliance for BDPaaS
            ...
            \item\ Work with partners and vendors on go-to-market strategies and evaluate future technology roadmaps
              \begin{itemize*}
                \item\ Intel, EMC, Dispersive Technologies, Dell, Lenovo
                \item\ RedHat, Cloudera, HortonWorks, Docker, DataStax
              \end{itemize*}
        \end{itemize*}
