...
\begin{itemize}
    \parskip=0.1em
      \item\
          \headerrow {\textbf{ASRC Federal}} {\textbf{Simpsonville, SC}}
          \headerrow {\emph{Fellow Information Engineer}} {\emph{Since October, 2021}}
        	\headerrow
          ...
          \begin{itemize*}
            ...
            \begin{itemize}
              \item Own technical architectures across UCSA
              \item Lead both ASRC and sub-contractor engineering teams in implementation
            \end{itemize}
              \end{itemize*}
      ...
      \item\
          ...
          \begin{itemize*}
            \item Work with clients from initial proposal stage to final delivery for technology engagements: Disney, Honda Racin
            \begin{itemize}
