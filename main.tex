...
\begin{itemize}
    \parskip=0.1em
      \item\
          ...
          \begin{itemize*}
            \item Work with Slower, LLC clients as both remote and on-premise resource for data platforms, cloud infrastructure, and automation
            \begin{itemize}
              \item Entertainment success story: develop Terraform v0.12+ automation for containerized Airflow in AWS production environment for large US video game company, develop initial proof-of-concept work in migrating large AWS data platform to GCP
              \item Automovie success story: deliver automated Kafka based data platform for large auto parts company, deliver CI/CD pipelines and associated tooling for ingress and egress of data              
            \end{itemize}
              \end{itemize*}
      \item\
