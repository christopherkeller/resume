...
\begin{itemize}
    \parskip=0.1em
      \item\
          \headerrow {\textbf{ASRC Federal}} {\textbf{Naval Air Station Pensacola, FL}}
          \headerrow {\emph{Fellow in Information Engineering}} {\emph{Since October, 2021}}
          \begin{itemize*}
            \item Assist OCTO IR\&D development of RIOT data platform
            \item Provide technical foundations for D\&I RFI responses
            \item Serve as expert technologist for both D\&I and ITS executive leadership
            \begin{itemize}
              \item Advise OCTO on setting up and using Enterprise GitHub
            \end{itemize}
            \item Develop and maintain relationship with commercial technology vendors: Red Hat, Databricks, Confluent, Elastic
            \item Set up and mainting cloud labs, budgets, and usage guard rails: AWS, Azure
            \item Participate in corporate engineering initiatives
            \begin{itemize}
              \item Present at internal technical summits to peers and leadership: 2022, 2023
              \item Participate in Centers of Excellence
            \end{itemize}
          \end{itemize*}
          \headerrow {\emph{DISA UCSA Technical Lead}} {\emph{Since March, 2022}}
          \begin{itemize*}
          ...
          \end{itemize*}
          \headerrow {\emph{DISA UCSA Executive IT Consultant}} {\emph{Since October, 2021}}
          \begin{itemize*}
