...
\begin{itemize}
    \parskip=0.1em
      \item\
          ...
          \begin{itemize*}
            \item Responsible for product architecture and engineering of patented streaming data platform
            \begin{itemize}
              \item Integration and automated installation/configuration of core components and APIs using Go, Python, Ansible, PostgreSQL, Cassandra, Zookeeper, Kafka, Solr, Elasticsearch
              \item Automated commercial overlays for TLS encryption and key/certificate management between all components
              \item Integration with public and on-premise cloud offerings: AWS, Azure, OpenStack, Openshift, KVM
              \item Develop in-stream filtering and masking via proprietary solution as well as KSQL
              \item Integration with common data frameworks and platforms such as Hadoop
              \item Intelligent orchestration for deploying multi-cloud virtual infrastructure overlaid by specific components for data platform
            \end{itemize}
              \item Manage internal and external engineering resources as well as open source community
              \item Design architecture for DataTrust blockchain using Hyperledger framework to address consumer data privacy laws (GDPR)
              \item Develop customer focused classes: technical mentorship, open source, devops, and embracing a culture of change
              \item Engage with all prospective and current clients, most recently
            \begin{itemize}
              \item Design and implement hybrid cloud strategy and data platform installation for large Australian insurance carrier
              \item Performance and scaling improvements for U.S. based health and analytics firm using data platform
            \end{itemize}
          \end{itemize*}
    \item\
        ...
        \begin{itemize*}
            \item Support sales process across offerings
            \item Develop and implement technical strategy
                \begin{itemize*}
    ...
    \headerrow
		...
		{\emph{Since 2015}}
	\begin{itemize*}
		\item Technical and business advisor to founding team; primarily focused on building a scaleable climate data platform
	\end{itemize*}
  ...
  \headerrow
    ...
    \headerrow
		...
		{\emph{2003--2004}}
	\begin{itemize*}
		\item Founded company to provide an aggressive open source approach to software and systems for U.S. intelligence agencies
	...
	\begin{itemize*}
		...
		\item Design and implement an autonomous ETL system for remote sensing data: C, Unix Shell, IDL
