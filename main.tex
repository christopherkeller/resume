...
\begin{itemize}
    ...
    \item\
        ...
        \headerrow {\emph{Principal Architect, Office of the CTO Emerging Technologies}} {\emph{Since 2015}}
        \begin{itemize*}
            \item\ Responsible for special projects within the OCTO around big data, cyber security, mobility, social, IoT, and next generation infrastructure
            \begin{itemize*}
              \item\ Develop a reference architecture for OpenStack, OpenShift, and containers
              \item\ Build Center of Excellence for Emerging Technologies in Austin, Texas
            \end{itemize*}
            \item\ Evaluate and recommend acquisition targets based on alignment with global strategy
            \item\ Work with partners on go-to-market strategies and evaluate future technology roadmaps
        \end{itemize*}
        ...
        \begin{itemize*}
            ...
            \item\ Responsible for overall platform security and certifications: HIPAA, FISMA, PCI/DSS
	...
	\begin{itemize*}
		...
		\item\ Linux kernel performance analysis \& tuning for realtime data processing
	\end{itemize*}
