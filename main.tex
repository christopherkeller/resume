...
\begin{itemize}
    \parskip=0.1em
      \item\
          \headerrow {\textbf{DataNexus, Inc}} {\textbf{Global}}
          \headerrow {\emph{Chief Technology Officer}} {\emph{Since 2016}}
          \begin{itemize*}
            \item Responsible for design and implementation of data routing platform
            \begin{itemize}
              \item Integration and automated installation/configuration of open source components using  Python, Ansible, PostgreSQL, Cassandra, Kafka, Solr
              \item Automated commercial overlays for TLS encryption and key/certificate management in and between all components
              \item Support metal and cloud deployment: Linux, AWS, Azure, OpenStack
            \end{itemize}
            ...
            \item Support all service engagements
            \begin{itemize}
